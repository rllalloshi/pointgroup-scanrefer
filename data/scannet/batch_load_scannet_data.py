...
def export_one_scan(scan_name, output_filename_prefix):    
    ...
    mesh_vertices, semantic_labels, instance_labels, instance_bboxes, instance2semantic, objects_pc = export(mesh_file, agg_file, seg_file, meta_file, LABEL_MAP_FILE, None)
    ...
    print("Number of objects in scene: " + str(len(objects_pc)))
    ...
    np.save(output_filename_prefix+ '_objects.npy', objects_pc)
